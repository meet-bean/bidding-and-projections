...
const SUPERIOR_SEED_METRICS: Metric[] = [
  // ── Period (CTP) ──────────────────────────────────────
  { id: 'ctp-qty',   name: 'CTP Qty',   aliases: [],            group: 'CTP', field: 'qty',   type: 'vista-upload', formula: null,                       formulaRefs: [] },
  { id: 'ctp-hrs',   name: 'CTP Hours', aliases: [],            group: 'CTP', field: 'hours', type: 'vista-upload', formula: null,                       formulaRefs: [] },
  ...
  { id: 'ctp-cost',  name: 'CTP Cost',  aliases: [],            group: 'CTP', field: 'cost',  type: 'vista-upload', formula: null,                       formulaRefs: [] },

  // ── To Date (CTD) ─────────────────────────────────────
  { id: 'ctd-qty',   name: 'CTD Qty',   aliases: [],            group: 'CTD', field: 'qty',   type: 'vista-upload', formula: null,                       formulaRefs: [] },
  { id: 'ctd-hrs',   name: 'CTD Hours', aliases: [],            group: 'CTD', field: 'hours', type: 'vista-upload', formula: null,                       formulaRefs: [] },
  ...
  // ── Forecast (F) ──────────────────────────────────────
  { id: 'f-qty',     name: 'F Qty',     aliases: [],            group: 'F',   field: 'qty',   type: 'vista-upload', formula: null,                       formulaRefs: [] },
  { id: 'f-hrs',     name: 'F Hours',   aliases: [],            group: 'F',   field: 'hours', type: 'vista-upload', formula: null,                       formulaRefs: [] },
  ...
  { id: 'f-cost',    name: 'F Cost',    aliases: ['Current Projection / Forecast', 'Current Forecast', 'Projection'], group: 'F', field: 'cost', type: 'carry-over', formula: null, formulaRefs: [], carryOverSource: 'lmf', fallback: { type: 'vista-upload' } },

  // ── Original Estimate (OE) ────────────────────────────
  { id: 'oe-qty',    name: 'OE Qty',    aliases: [],            group: 'OE',  field: 'qty',   type: 'vista-upload', formula: null,                       formulaRefs: [] },
  { id: 'oe-hrs',    name: 'OE Hours',  aliases: [],            group: 'OE',  field: 'hours', type: 'vista-upload', formula: null,                       formulaRefs: [] },
  ...
  { id: 'oe-cost',   name: 'OE Cost',   aliases: [],            group: 'OE',  field: 'cost',  type: 'vista-upload', formula: null,                       formulaRefs: [] },

  // ── Projection ────────────────────────────────────────
  { id: 'lmf',       name: "Last Month's Forecast", aliases: ['Last months forecast'], group: 'PRJ', field: 'cost', type: 'carry-over', formula: null, formulaRefs: [], carryOverSource: 'f-cost', fallback: { type: 'vista-upload' } },
